...
#define OD_DIGITAL_INPUTS			   0x60FD,0x00		//RO: uint32_t	
...
#define OD_MOTOR_RATED_TORQUE		   0x6076, 0x00		//RW: uint32_t	check EPOS4 Firmware Specification pg. 231
...
#define OD_ANALOG_OUTPUT_PROPERTIES_1  0x3180,0x01
#define OD_ANALOG_OUTPUT_PROPERTIES_2  0x3180,0x02

// CKim - Defines for Homing
#define OD_HOMING_METHOD 0x6098, 0x00				// RW: uint8_t \see EPOS4-Firmware-Specification pg. 213
#define OD_HOMING_SWITCH_SEARCH_SPEED 0x6099, 0x01	// RW: uint32_t \see EPOS4-Firmware-Specification pg. 214
#define OD_HOMING_ZERO_SEARCH_SPEED 0x6099, 0x02	// RW: uint32_t \see EPOS4-Firmware-Specification pg. 214
#define OD_HOMING_ACCEL 0x609A, 0x00				// RW: uint32_t \see EPOS4-Firmware-Specification pg. 215. Default 1000
#define OD_HOME_OFFSET 0x30B1, 0x00					// RW: uint32_t \see EPOS4-Firmware-Specification pg. 178
#define OD_HOME_POSITION 0x30B0, 0x00				// RW: uint32_t \see EPOS4-Firmware-Specification pg. 177. Default 0

// CKim - Abs Encoder are accessible to PDO in index Additional Position Data
#define OD_ADDITIONAL_POSITION_ACTUAL2 0x60E4, 0x02 // RO: int32_t
